...
- 2026-09-22: PS-BID17-029..032 on staging (653a927). Caregiver path aligned: /gift+redeem paper+gold (widget deduped), /purchase/success+cancel aligned-neutral (shared w/ learner). Cancel-page entitlement probe kills paywall loop (loadPaidUnit canary; entitled→paid-curriculum, CTA suppressed). 251 unit green + guard/grammar pins; Jev post-change 0.79 ship, 1.87 clean. Verified live on staging.
- 2026-09-22: PS-BID17-029..032 promoted to prod (2ceb4cf). Deploy green, CI all-6 green. Prod matrix 592/615 — 3 failures all flakes retried green (44/44): firefox help-callback Back-test + iPadMini text + webkit caregiver CTA. Jev: clean release 0.90; flagged systemic fix for firefox help-callback flake family (0.81). PS-BID17-033 gift-cancel copy ticket (is_gift branch, Jev).
- 2026-09-26: PS-INSIGHTS-001 blog feature intake — SageAge /blog benchmark crawled (94 posts, 12/pg). Pressure test found SPA has zero per-route SEO → static-HTML generation required (terms.html precedent). 24-source verified library built via eutils + whitepaper cross-ref (4 bad PMIDs caught). Jev: arch 0.89, persona 0.82, ship 0.65; judge2 9/8/9. Awaiting owner on label/route + article count.
