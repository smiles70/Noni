 ...
 * 
 * Sprint: G3 Prevention — Post-build verification
...
try {
  ...
  console.error(`❌ Bundle verification failed: ${DIST_DIR} not found`);
...
try {
  ...
  console.error(`❌ Bundle verification failed: ${assetsDir} not found`);
  exit(1);
}
