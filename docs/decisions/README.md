...
- [0022 - Free tier: Modules 1-2](./0022-free-tier-modules-1-2.md)
- [0022 - Vendor topology](./0022-vendor-topology.md)
- [0023 - Auth and session model](./0023-auth-and-session-model.md)
- [0024 - Database operational policy](./0024-database-operational-policy.md)
- [0025 - Secrets and configuration](./0025-secrets-and-configuration.md)
- [0026 - Color contrast alignment](./0026-color-contrast-alignment.md)
- [0027 - Magic.link auth](./0027-magic-link-auth.md)
- [0028 - Landing hero redesign](./0028-landing-hero-redesign.md)
- [0029 - Landing hero contract exemption](./0029-landing-hero-contract-exemption.md)
- [0030 - Marketing surfaces annex](./0030-marketing-surfaces-annex.md)
- [0032 - Retell website chat widget on caregiver and facility journeys](./0032-website-chat-widget.md)
