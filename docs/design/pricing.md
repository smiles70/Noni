...
### Guarantee
"Not sure? Every purchase includes a 30-day, no-questions-asked refund. If you are not satisfied, we will refund you in full."
...
## Geragogy Compliance Checklist

- [x] No countdown timers or scarcity language
- [x] No "limited time" messaging
- [x] No social-proof urgency
- [x] Price displayed clearly before any payment step
- [x] Refund policy visible on the same page
- [x] No engagement-triggered upsells
- [x] No bundling with marketing consent
